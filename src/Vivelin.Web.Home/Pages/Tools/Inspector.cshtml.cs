...
public class InspectorModel : PageModel
{
    ...
    public record CodePoint
    {
        ...
        {
            UnicodeCharInfo charInfo = UnicodeInfo.GetCharInfo(rune.Value);
            ...
            byte[] utf8Bytes = new byte[rune.Utf8SequenceLength];
            if (rune.TryEncodeToUtf8(utf8Bytes, out int bytesWritten))
            {
