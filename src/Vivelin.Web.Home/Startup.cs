...
public class Startup(IConfiguration configuration)
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        services
            ...
            .AddTwitch(options =>
            {
                options.ClientId = Configuration["Twitch:ClientId"] ?? throw new InvalidOperationException("Twitch:ClientId app settings is required.");
                options.ClientSecret = Configuration["Twitch:ClientSecret"] ?? throw new InvalidOperationException("Twitch:ClientSecret app setting is required.");
